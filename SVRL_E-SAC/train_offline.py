...
def get_config():
    ...
    parser.add_argument("--run_name", type=str, default="SVRL_E_SAC", help="Run name prefix, default: CQL")
    ...
    parser.add_argument("--lambda_recon", type = float, default = 0.1, help = "")
    parser.add_argument("--mask_prob", type = float, default = 0.4, help = "")
    parser.add_argument("--tau", type=float, default=5e-3, help="")
    parser.add_argument("--eval_every", type=int, default=1, help="")
    parser.add_argument("--zeta", type = int, default = 50, help = "")
...
def train(config):
    ...
    with wandb.init(project="Offline SAC Exp (halfcheetah-medium-v2)", group = "SVRL-E-SAC", name=config.run_name, 
                    mode = "offline", config=config):
        
        agent = SVRLSAC(state_size=env.observation_space.shape[0],
