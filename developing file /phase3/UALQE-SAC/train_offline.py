...
def get_config():
    ...
    parser.add_argument("--run_name", type=str, default="UALQE_SAC", help="Run name prefix, default: CQL")
    ...
    parser.add_argument("--lambda_weight", type = float, default=0.3, help="")
    parser.add_argument("--rank", type=int, default=5,help="")
...
def train(config):
    ...
    with wandb.init(project="Offline SAC Exp (halfcheetah-medium-v2)", group = "UALQE-SAC", name=config.run_name, config=config):
        
        agent = SVRLSAC_E(state_size=env.observation_space.shape[0],
